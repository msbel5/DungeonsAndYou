...
{
    public class CharacterForSheet
    {
        ...
        public CharacterForSheet(string name, int[] abilityPoints_SDCIWC, Race race, Class CharClass, EAlignment alignment, Background background)
        {
        ...
        public CharacterForSheet(CharacterSheet cs)
        {
